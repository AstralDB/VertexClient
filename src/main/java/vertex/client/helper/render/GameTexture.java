...
public enum GameTexture {
    TEXTURE_ICON(new Texture("tex/icon"), "res:///assets/vertex/icon.png"),
    TEXTURE_BACKGROUND(new Texture("tex/background"), "res:///assets/vertex/background.png"),
    ICONS_UTIL(new Texture("text/icon"), "res:///assets/vertex/util.png"),
