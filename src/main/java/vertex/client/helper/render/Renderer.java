...
import vertex.client.helper.math.Matrix4x4;
import vertex.client.helper.math.Vector3D;
...
public class Renderer {
    ...
    public static class R3D {
        ...
        public static void renderCircleOutline(MatrixStack stack, Color c, Vec3d start, double rad, double width, double segments) {
            Camera camera = VertexMain.client.gameRenderer.getCamera();
        ...
        public static void renderOutline(Vec3d start, Vec3d dimensions, Color color, MatrixStack stack) {
            ...
            Camera c = VertexMain.client.gameRenderer.getCamera();
    ...
    public static class R2D {
        ...
        public static Vec2f renderTooltip(MatrixStack stack, double arrowX, double arrowY, double width, double height, Color color, boolean renderUpsideDown) {
            double centerX = VertexMain.client.getWindow().getScaledWidth() / 2d;
            /*
            left:
            *           /\
            * --------------
        ...
        public static void beginScissor(double x, double y, double endX, double endY) {
            ...
            float mulScale = (float) VertexMain.client.getWindow().getScaleFactor();
            int invertedY = (int) ((VertexMain.client.getWindow().getScaledHeight() - (y + height)) * mulScale);
        ...
        public static Vec3d getScreenSpaceCoordinate(Vec3d pos, MatrixStack stack) {
            Camera camera = VertexMain.client.getEntityRenderDispatcher().camera;
            Matrix4f matrix = stack.peek().getPositionMatrix();
            ...
            int displayHeight = VertexMain.client.getWindow().getHeight();
            ...
            return new Vec3d(screenCoords.x / VertexMain.client.getWindow().getScaleFactor(),
                    (displayHeight - screenCoords.y) / VertexMain.client.getWindow().getScaleFactor(),
                    screenCoords.z
            );
        }
