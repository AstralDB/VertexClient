...
public class AimAssist extends Module {
    ...
    public void tick() {
        ...
        if (aimAtCombatPartner.getValue()) {
            ...
            for (Entity entity : Objects.requireNonNull(VertexMain.client.world).getEntities()) {
                ...
                if (entity.getPos().distanceTo(VertexMain.client.player.getPos()) > Objects.requireNonNull(VertexMain.client.interactionManager)
                        .getReachDistance()) {
                    continue;
                }
    ...
    void aimAtTarget() {
        if (!aimInstant.getValue()) {
            ...
            Objects.requireNonNull(VertexMain.client.player).setPitch(py.x);
            VertexMain.client.player.setYaw(py.y);
        }
    }
