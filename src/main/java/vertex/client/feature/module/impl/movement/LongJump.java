...
public class LongJump extends Module {
    ...
    Vec3d getVel() {
        float f = Objects.requireNonNull(VertexMain.client.player).getYaw() * 0.017453292F;
        ...
        return switch (focus.getValue()) {
            ...
            case Velocity -> new Vec3d(VertexMain.client.player.getVelocity().normalize().x * scaled,
                    0.0D,
                    VertexMain.client.player.getVelocity().normalize().z * scaled
            );
        };
    }
