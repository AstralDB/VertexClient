...
import vertex.client.helper.manager.HologramManager;
...
public class Hologram extends Command {
    ...
    public void onExecute(String[] args) throws CommandException {
        ...
        Vec3d pos = Objects.requireNonNull(VertexMain.client.player).getPos();
        BlockPos displayable = VertexMain.client.player.getBlockPos();
        ...
        VertexMain.client.player.getInventory().addPickBlock(stack);
    }
}
