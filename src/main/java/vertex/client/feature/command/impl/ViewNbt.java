...
public class ViewNbt extends Command {
    ...
    public void onExecute(String[] args) {
        ...
        ItemStack stack = VertexMain.client.player.getInventory().getMainHandStack();
        ...
        if (formatted) {
            ...
            if (noColor) {
                VertexMain.client.player.sendMessage(Text.of(c.asString()), false);
            } else {
                VertexMain.client.player.sendMessage(NbtHelper.toPrettyPrintedText(c), false);
            }
        }
        if (copy) {
            VertexMain.client.keyboard.setClipboard(c.asString());
            success("Copied nbt!");
        }
    }
