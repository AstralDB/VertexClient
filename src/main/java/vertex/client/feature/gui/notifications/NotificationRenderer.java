...
package vertex.client.feature.gui.notifications;
...
public class NotificationRenderer {
    ...
    public static void renderTop() {
        ...
        int baseX = VertexMain.client.getWindow().getScaledWidth() / 2;
        int height = 16;
        int baseY = -height - 5;
    ...
    public static void renderSide() {
        ...
        MatrixStack ms = Renderer.R3D.getEmptyMatrixStack();
        double yOffset = 0;
        double bottomRightStartX = VertexMain.client.getWindow().getScaledWidth() - padding;
        double bottomRightStartY = VertexMain.client.getWindow().getScaledHeight() - padding;
