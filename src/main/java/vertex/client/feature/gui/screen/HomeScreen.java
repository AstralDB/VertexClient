...
import vertex.client.feature.gui.ParticleRenderer;
...
public class HomeScreen extends ClientScreen {
    ...
    void initWidgets() {
        ...
        buttonsMap.add(new AbstractMap.SimpleEntry<>("Singleplayer", () -> VertexMain.client.setScreen(new SelectWorldScreen(this))));
        buttonsMap.add(new AbstractMap.SimpleEntry<>("Multiplayer", () -> VertexMain.client.setScreen(new MultiplayerScreen(this))));
        buttonsMap.add(new AbstractMap.SimpleEntry<>("Backdoors", () -> VertexMain.client.setScreen(new RealmsMainScreen(this))));
        buttonsMap.add(new AbstractMap.SimpleEntry<>("Alts", () -> {
            VertexMain.client.setScreen(new NotificationScreen(
        ...
        buttonsMap.add(new AbstractMap.SimpleEntry<>("Settings", () -> VertexMain.client.setScreen(new OptionsScreen(this, VertexMain.client.options))));
        buttonsMap.add(new AbstractMap.SimpleEntry<>("Quit", VertexMain.client::scheduleStop));
        double w = 60;
    ...
    public void renderInternal(MatrixStack stack, int mouseX, int mouseY, float delta) {
        ...
        propFr.drawString(stack, "Trollage V0.1 - Created By Orly", 6, 6, 0xFFFFFF, false);
        ...
        RenderSystem.defaultBlendFunc();
        String uname = VertexMain.client.getSession().getUsername();
