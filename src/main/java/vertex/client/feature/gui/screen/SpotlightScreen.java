...
import vertex.client.helper.manager.ShaderManager;
    ...
    public static class CommandTextField implements Element, Drawable, Selectable, DoesMSAA {
        ...
        public boolean keyPressed(int key, int scanCode, int mods) {
            ...
            if (control && key == GLFW.GLFW_KEY_C) {
                if (cursor != selectionStart || cursor != selectionEnd) {
                    VertexMain.client.keyboard.setClipboard(text.substring(selectionStart, selectionEnd));
                }
                return true;
        ...
        public boolean onKeyRepeated(int key, int mods) {
            ...
            if (control && key == GLFW.GLFW_KEY_V) {
                ...
                String preText = text;
                String clipboard = VertexMain.client.keyboard.getClipboard();
                int addedChars = 0;
