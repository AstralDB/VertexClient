...
import vertex.client.feature.module.impl.render.Radar;
...
public class RadarElement extends HudElement {
    ...
    public void renderIntern(MatrixStack stack) {
        ...
        if (radar.isEnabled()) {
            ...
            Vec3d ppos = Utils.getInterpolatedEntityPosition(VertexMain.client.player);
            ...
            stack.multiply(new Quaternion(0, 0, -VertexMain.client.player.getYaw() - 180, true));
