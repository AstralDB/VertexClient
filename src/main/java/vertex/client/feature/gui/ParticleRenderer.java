...
package vertex.client.feature.gui;
...
public class ParticleRenderer {
    ...
    void addParticle() {
        ...
        n.x = VertexMain.client.getWindow().getScaledWidth() * Math.random();
        n.y = VertexMain.client.getWindow().getScaledHeight() * Math.random();
    ...
    static class Particle {
        ...
        void move() {
            ...
            x += velX;
            y += velY;
            double h = VertexMain.client.getWindow().getScaledHeight();
            double w = VertexMain.client.getWindow().getScaledWidth();
            if (x > w || x < 0) {
                velX *= -1;
            }
            if (y > h) {
